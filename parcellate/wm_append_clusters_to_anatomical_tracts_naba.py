...
try:
    ...
    print("<wm_append_clusters_to_anatomical_tracts_naba.py> Error importing white matter analysis package\n")
    raise
...
hemispheric_tracts = ["T_AF", "T_CB_D", "T_CB_V", "T_EmC", "T_ILF", "T_IOFF", "T_MdLF", "T_SLF-I", "T_SLF-II", "T_SLF-III",
                     "T_UF", "T_ICP", "T_Intra-CBLM-I&P", "T_Intra-CBLM-PaT", "T_SCP", "T_CST", "T_CR-F", "T_CR-P", "T_SF", "T_SO",
                     "T_SP", "T_TF", "T_TO", "T_TT", "T_TP", "T_EC", "T_Sup-F", "T_Sup-FP", "T_Sup-O", "T_Sup-OT", "T_Sup-P",
                     "T_Sup-PO", "T_Sup-PT", "T_Sup-T"]

commissural_tracts = ["T_CC1", "T_CC2", "T_CC3", "T_CC4", "T_CC5", "T_CC6", "T_CC7", "T_CPC", "T_MCP"]
